...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $(" <div class='controls'><fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year form-control' name='birth[year]' required></select>"),
          $month = $("<select class='birth-month form-control'  name='birth[month]' required></select>"),
          $day = $("<select class='birth-day form-control'  name='birth[day]' required></select></div>");
      ...
      if (settings["hiddenDate"]) {
        $("<input class='form-control' type='hidden' id='birthdayhidden' name='" + settings["fieldName"] + "' data-validation-required-message='Birthday' required /> ")
